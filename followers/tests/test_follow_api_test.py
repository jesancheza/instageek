...
class FollowAPITests(APITestCase):
    ...
    def test_endpoint_resturns_400_bad_request_when_no_target_user_is_sent(self):
    ...
    def test_endpoint_resturns_400_bad_request_when_target_user_doesnt_exist(self):
